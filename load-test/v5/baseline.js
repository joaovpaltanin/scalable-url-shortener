...
export function setup() {
  ...
  console.log("Writes go to shard primaries (2 shards).");
  console.log("Cache misses read from shard replicas (with primary fallback).");
  return { codes };
}
...
========================================
  Primaries handle writes, replicas handle
  cache-miss reads (eventual consistency).
========================================
`;
