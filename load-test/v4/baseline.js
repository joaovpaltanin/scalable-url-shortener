...
export function setup() {
  ...
  console.log("Writes are now distributed across 2 PostgreSQL shards.");
  console.log("Reads hit Redis first, falling back to the correct shard on miss.");
  return { codes };
}
...
========================================
  Writes are distributed across 2 shards.
  Compare write throughput with V3 to see
  the sharding improvement.
========================================
`;
